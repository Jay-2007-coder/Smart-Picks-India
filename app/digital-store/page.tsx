...
import { Search, Filter, BookOpen, Download, Star, Sparkles, Tag, ArrowRight } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950/20 py-12">
      <div className="container-custom">
        {/* Banner Section */}
        <div className="relative rounded-3xl overflow-hidden bg-gradient-to-br from-slate-900 via-neutral-900 to-rose-950 px-8 py-16 text-white text-center shadow-xl border border-white/5 mb-12 select-none">
          ...
          <div className="max-w-2xl mx-auto relative z-10">
            <span className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full text-xs font-black bg-rose-500/20 text-rose-300 border border-rose-500/30 uppercase tracking-widest mb-6">
            ...
            <div className="flex justify-center gap-3">
              <Link
                href="/student-hub"
                className="inline-flex items-center gap-1.5 rounded-2xl bg-white text-neutral-950 px-6 py-3 text-xs font-bold hover:bg-slate-100 shadow-lg hover:shadow-xl transition-all"
              >
        ...
        <div className="grid lg:grid-cols-4 gap-8">
              ...
              <div className="space-y-1.5">
                {categories.map((cat) => (
                  <button
                    ...
                    className={`flex items-center justify-between w-full px-3.5 py-2.5 rounded-xl text-xs font-bold transition-all ${
              ...
              <div className="grid grid-cols-3 gap-2">
                {["all", "free", "paid"].map((t) => (
                  <button
                    ...
                    className={`h-9 rounded-xl text-[10px] font-black capitalize transition-all border ${
                      selectedType === t
                        ? "border-brand-600 bg-brand-50/50 text-brand-600 dark:bg-brand-950/20"
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-card border border-border/80 rounded-3xl px-6 py-4 shadow-sm">
              ...
              <div className="flex items-center gap-3">
                ...
                <select
                  ...
                  className="h-10 bg-background border border-border rounded-xl px-3 text-xs font-bold text-foreground focus-visible:outline-none"
                >
            ...
            {loading ? (
              ...
              <div className="bg-card border border-border/80 rounded-3xl py-20 text-center shadow-sm">
                      ...
                      <div className="p-5 flex-1 flex flex-col justify-between">
                        ...
                        <div className="flex items-center justify-between border-t border-border/50 mt-5 pt-4">
                          ...
                          <Link
                            ...
                            className="inline-flex h-9 items-center justify-center rounded-xl bg-brand-600 px-4 text-xs font-bold text-white hover:bg-brand-700 shadow-sm transition-all duration-200"
                          >
                            Get Details
                          </Link>
                        </div>
